...
| 招待中継ページ | `docs/invite/index.html` を GitHub Pages（`develop` ブランチ `/docs`）で配信。`https://kyota1210.github.io/DaiB-app2026/invite/?u=<userId>`。「アプリで開く」（`daibapp://invite/<userId>`）と App Store の2択を提示する。 |
