...
const translations = {
    ja: {
        ...
        selectDefaultSortOrder: '一覧を開いたときに並び替えの基準を選択',
        appSettings: 'アプリ設定',
    ...
    en: {
        ...
        defaultSortOrder: 'Default list sort order',
        sortByDateLogged: 'By post date',
        sortByCreatedAt: 'By created date',
        selectDefaultSortOrder: 'Select sort order when opening the list',
